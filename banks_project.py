...
# 3. Print only the names and costs in EUR of the top 5 banks

query_statement = f"SELECT Name, MC_EUR_Billion from {table_name} ORDER BY MC_EUR_Billion DESC LIMIT 5 "
run_query(query_statement, sql_connection)
